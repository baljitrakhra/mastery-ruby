...
direction_c = nil
while direction_c != "North" || direction_c != "South"
  puts "Enter your direction : North or South"
  direction_p = gets.chomp.capitalize
  while true
    if direction_p == "North"
  ...
  puts "Enter your direction : North or South"
  direction_c = gets.chomp.capitalize
  if direction_c == "North"
    puts "You walk into sunlight."
    break
  elsif direction_c == "South"
